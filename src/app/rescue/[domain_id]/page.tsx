...
import { getRescueDetail, getResiduePlddts, getSequences, getStructurePaths, getStrandExchange, getHbonds, getDomainCompleteness, getProteinComparison, getPocketSignature, getReclassificationProposal } from '@/lib/queries';
...
export default async function DomainDetailPage({ params }: PageProps) {
  ...
  const [detail, plddts, sequences, structures, exchange, hbonds, completeness, proteinComparison, pocket, reclassification] = await Promise.all([
